package archenoah.web.normal.main.Menuepunkte.Individuelle.Projekte.Projektuebersicht.replagal.form;
...
import archenoah.web.normal.main.Menuepunkte.Individuelle.Projekte.Projektuebersicht.replagal.classes.ReplagalNurseCombos;
...
public class replagal_insert_edit extends CustomComponent {
    ...
    @AutoGenerated
    private ComboBox cbx_caused_by;

    @AutoGenerated
    private Label lbl_caused_by;
    ...
    @AutoGenerated
    private ComboBox cbx_prescribed_dose;
    ...
    @AutoGenerated
    private TextField txt_adm_replagal_vol;

    @AutoGenerated
    private Label lbl_adm_replagal_vol;
    ...
    @AutoGenerated
    private TextField txt_adm_replagal_amp;

    @AutoGenerated
    private Label lbl_mg;

    @AutoGenerated
    private TextField txt_adm_replagal_mg;

    @AutoGenerated
    private Label lbl_replagal;
...
//    private String Exportname;
    ...
    /************ ----->Einstellungen<-- ********************/
//    private final String LNG_FRM_ID = "38";
    private final String BER_MEN_ID = "38"; //from ReplagalDataView
    ...
    public replagal_insert_edit(MenuItem Arg_Menü, String Arg_Form_ID) {
        Temp_Menü = Arg_Menü;
        Form_ID = Arg_Form_ID;
    ...
    public replagal_insert_edit(Button Arg_btn, String Arg_Form_ID) {
    ...
    public void Init_Class_Window() {
        ...
        Build_Window_Button bwb = new Build_Window_Button(generateTitle(), mainLayout, Windows_Height, Windows_Width, generateResource());
    ...
    private String generateTitle(){
        ...
        if(Temp_Btn != null){
            caption = Temp_Btn.getCaption();
        }else if(Temp_Menü != null){
            caption = Temp_Menü.getText();
        }
    ...
    private Resource generateResource(){
        ...
        if(Temp_Menü != null){
            ...
            res = new ThemeResource(Recourcename);
        }else if(Temp_Btn != null){
            res = Temp_Btn.getIcon();
        }
...
//            setupOrderStatus(); //irrelevant?
        ...
        fillNeedles(true); // legacy handling
        event();
        /********************** Components Setup *******************************/
        ...
        new RegexValidator(txt_adm_replagal_mg, "[\\d]*[,]?[\\d]*", null, null, false);
        new RegexValidator(txt_vitals_pressure_reaction, "([\\d]{1,3}[\\:\\/][\\d]{1,3})?", null, null, false);
        new RegexValidator(txt_vitals_temp_end, "[\\d]{2}(,[\\d]*)?", null, null, false);
        new RegexValidator(txt_vitals_pressure_end, "([\\d]{1,3}[\\:\\/][\\d]{1,3})?", null, null, false);
        new RegexValidator(txt_vitals_pressure_start, "([\\d]{1,3}[\\:\\/][\\d]{1,3})?", null, null, false);
        new RegexValidator(txt_vitals_pulse_start, "[\\d]*", null, null, false);
        new RegexValidator(txt_spot_count, "[\\d]*", null, null, false);
        new RegexValidator(txt_adm_replagal_vol, "[\\d]*[,]?[\\d]*", null, null, false);
        new RegexValidator(txt_remaining_patient, "[\\d]*", null, null, false);
        new RegexValidator(txt_premed_1_time, "(([01]?[0-9]|2[0-3]):?[0-5][0-9])?", null, null, false);
        new RegexValidator(txt_vitals_temp_start, "[\\d]{2}(,[\\d]*)?", null, null, false);
        new RegexValidator(txt_inf_time_start, "(([01]?[0-9]|2[0-3]):?[0-5][0-9])?", null, null, false);
        new RegexValidator(txt_vitals_pulse_reaction, "[\\d]*", null, null, false);
        new RegexValidator(txt_vitals_mad_start, "[\\d]*", null, null, false);
        new RegexValidator(txt_vitals_mad_reaction, "[\\d]*", null, null, false);
        new RegexValidator(txt_vitals_pulse_end, "[\\d]*", null, null, false);
        new RegexValidator(txt_vitals_time_end, "(([01]?[0-9]|2[0-3]):?[0-5][0-9])?", null, null, false);
        new RegexValidator(txt_vitals_time_start, "(([01]?[0-9]|2[0-3]):?[0-5][0-9])?", null, null, false);
        new RegexValidator(txt_vitals_time_reaction, "(([01]?[0-9]|2[0-3]):?[0-5][0-9])?", null, null, false);
        new RegexValidator(txt_remaining_nurse, "[\\d]*", null, null, false);
        new RegexValidator(txt_inf_time_stop, "(([01]?[0-9]|2[0-3]):?[0-5][0-9])?", null, null, false);
        new RegexValidator(txt_vitals_mad_end, "[\\d]*", null, null, false);
        new RegexValidator(txt_inf_rate, "[\\d]*[,]?[\\d]*", null, null, false);
        new RegexValidator(txt_adm_replagal_amp, "[\\d]*", null, null, false);
        new RegexValidator(txt_Gesamte_Km, "^\\d*$", null, null, false);
        new RegexValidator(txt_premed_3_time, "(([01]?[0-9]|2[0-3]):?[0-5][0-9])?", null, null, false);
        new RegexValidator(txt_premed_2_time, "(([01]?[0-9]|2[0-3]):?[0-5][0-9])?", null, null, false);
        new RegexValidator(txt_vitals_temp_reaction, "[\\d]{2}(,[\\d]*)?", null, null, false);
        // migration end
...
//        txt_vitals_time_end.setReadOnly(true);
        ...
        cbx_prescribed_dose.setImmediate(true);
        togglePrescribedDoseReason();
        cbx_caused_by.setImmediate(true);
    ...
    private void fillLimit() {
        limit = new ProjectLimits("REP", Form_ID, MyUtils.getValueFromItem(dataSetItem, "PRD_DELEGATION_ID", Integer.class));
        limit.setNurseSelect(cb_nurse);
        limit.setStatusSelect(ns_status);
        limit.setOriginalDate(MyUtils.getValueFromItem(dataSetItem, "PRD_ORIGINAL_DATE", Date.class));
    ...
    private void event() {
            ...
            public void buttonClick(ClickEvent event) {
                ...
                if (charge.length() > 0) {
                    ...
                    if (cs.getContainerPropertyIds().size() == 0) {
                        ...
                        cs.addContainerProperty("PRC_ID", Integer.class, 0);
                        cs.addContainerProperty("PRC_PRD_ID", Integer.class, 0);
                        cs.addContainerProperty("PRC_COUNT", Integer.class, 0);
                        cs.addContainerProperty("PRC_NR", String.class, 0);
                        cs.addContainerProperty("display", String.class, 0);

                    }

                    for (Object o : cs.getItemIds()) {
                        if (cs.getContainerProperty(o, "PRC_NR").getValue().equals(charge)) {
                    ...
                    if (!StringUtils.isNullOrEmpty(Form_ID)) {
                        item.getItemProperty("PRC_PRD_ID").setValue(Integer.parseInt(Form_ID));
                    }

                    item.getItemProperty("display").setValue(int_chargeCount.getValue() + "x " + charge);
                    item.getItemProperty("PRC_COUNT").setValue(int_chargeCount.getValue());
                    item.getItemProperty("PRC_NR").setValue(charge);
        ...
        cbx_prescribed_dose.addValueChangeListener(new ValueChangeListener() {
        ...
        cb_nurse.addValueChangeListener(new ValueChangeListener() {
            ...
            public void valueChange(ValueChangeEvent event) {
                ...
                if(ns_status.getValue().equals(2)) {
                    ns_status.setValue(1);
                }
    ...
    private void togglePrescribedDoseReason(){
        Boolean isEnabled = MyUtils.equalsWithNulls(cbx_prescribed_dose.getValue(), 0);
    ...
    private void limitDatepicker(Date min){
        
        pop_date.setRangeStart(min);
        
    }
    
    private void setupOrderStatus() {
        dbGetProtocolOrderStatus();

        if (orderItem == null) {
//            limitDatepicker(dbGetProtocolOrderPrevious());
//        	showDateWarning(dbGetProtocolOrderPrevious());
        } else {
            String status = (String) orderItem.getItemProperty("OMMS_VALUE").getValue();
            
            System.out.println(status);
            
            if(status.equals("order_placed") || status.equals("nurse_sent")){
                
//                limitDatepicker(new Date(((java.sql.Date) orderItem.getItemProperty("min_date_current").getValue()).getTime()));
//            	showDateWarning(new Date(((java.sql.Date) orderItem.getItemProperty("min_date_current").getValue()).getTime()));
    ...
    private void showDateWarning(Date date){
    	...
    	Notification notif = new Notification("Information", "\nDas vom Bestellsystem vorgegebene Mindestdatum ist: " + format.format(date) + 
    			"\n(Diese Nachricht dient zur Überprüfung der geplanten Funktionalität und wird nicht in der endgültigen Implementierung erscheinen)", Type.HUMANIZED_MESSAGE);

			// Customize it
			notif.setDelayMsec(5000);
//			notif.setPosition(Posit[Pos_Notfi]);
			// Show it in the page
    ...
    private void calcInf(boolean replace) {
        ...
        if (!txt_inf_time_start.isValid() || !txt_inf_time_stop.isValid() || !txt_adm_replagal_vol.isValid()) {
            return;
        }
        ...
        String vvol = txt_adm_replagal_vol.getValue();
    ...
    private void Set_DB_Map() {
        DBMap = new HashMap<>();
        DBMap.put(pop_date, "cust_protokoll_replagal_daten:PRD_DATE");

        DBMap.put(txt_von, "cust_protokoll_replagal_daten:PRD_VON");
        DBMap.put(txt_bis, "cust_protokoll_replagal_daten:PRD_BIS");

        DBMap.put(cb_pat, "cust_protokoll_replagal_daten:PRD_P_ID");
        DBMap.put(cb_nurse, "cust_protokoll_replagal_daten:PRD_K_ID");
        DBMap.put(cbx_arzt, "cust_protokoll_replagal_daten:PRD_ARZT_ID");
        DBMap.put(ns_status, "cust_protokoll_replagal_daten:PRD_STATUS");
        
        DBMap.put(cb_regionalmanager_ok, "cust_protokoll_replagal_daten:PRD_REGIONAL_MANAGER_OK");

        DBMap.put(ns_Stunden, "cust_protokoll_replagal_daten:PRD_FAHRTZEIT_STD_N");
        DBMap.put(ns_min, "cust_protokoll_replagal_daten:PRD_FAHRTZEIT_MIN_N");
        //DBMap.put(ns_anrufe, "cust_protokoll_replagal_daten:PRD_ANRUFE");
        DBMap.put(ns_Abrechnung_Minuten, "cust_protokoll_replagal_daten:PRD_FAHRTZEIT_MIN");
        DBMap.put(ns_Abrechnung_Stunden, "cust_protokoll_replagal_daten:PRD_FAHRTZEIT_STD");
        DBMap.put(txt_Abrechnungs_Km, "cust_protokoll_replagal_daten:PRD_GES_KM");
        DBMap.put(txt_Gesamte_Km, "cust_protokoll_replagal_daten:PRD_GES_KM_N");
        DBMap.put(cb_admin, "cust_protokoll_replagal_daten:PRD_ADMINPAUSCHALE");
        DBMap.put(cb_parallel, "cust_protokoll_replagal_daten:PRD_PARALLEL");

        DBMap.put(cbx_type, "cust_protokoll_replagal_daten:PRD_INFUSIONSTYP");

        DBMap.put(txt_pat_weigth, "cust_protokoll_replagal_daten:PRD_GEW");
        DBMap.put(txt_premed_1, "cust_protokoll_replagal_daten:PRD_PRAE_MED_N_1");
        DBMap.put(txt_premed_1_time, "cust_protokoll_replagal_daten:PRD_PRAE_MED_Z_1");
        DBMap.put(txt_premed_2, "cust_protokoll_replagal_daten:PRD_PRAE_MED_N_2");
        DBMap.put(txt_premed_2_time, "cust_protokoll_replagal_daten:PRD_PRAE_MED_Z_2");
        DBMap.put(txt_premed_3, "cust_protokoll_replagal_daten:PRD_PRAE_MED_N_3");
        DBMap.put(txt_premed_3_time, "cust_protokoll_replagal_daten:PRD_PRAE_MED_Z_3");
        DBMap.put(cb_ellbow_right, "cust_protokoll_replagal_daten:PRD_PUNKT_ORT_E_R");
        DBMap.put(cb_ellbow_left, "cust_protokoll_replagal_daten:PRD_PUNKT_ORT_E_L");
        DBMap.put(cb_hand_right, "cust_protokoll_replagal_daten:PRD_PUNKT_ORT_H_R");
        DBMap.put(cb_hand_left, "cust_protokoll_replagal_daten:PRD_PUNKT_ORT_H_L");
        DBMap.put(cb_forearm_right, "cust_protokoll_replagal_daten:PRD_PUNKT_ORT_U_R");
        DBMap.put(cb_forearm_left, "cust_protokoll_replagal_daten:PRD_PUNKT_ORT_U_L");
        DBMap.put(txt_spot_count, "cust_protokoll_replagal_daten:PRD_PUNKT_VERS");
        DBMap.put(cbx_needle, "cust_protokoll_replagal_daten:PRD_PUNKT_NADEL");
        DBMap.put(txt_adm_replagal_mg, "cust_protokoll_replagal_daten:PRD_DOSIERUNG");
        DBMap.put(txt_adm_replagal_amp, "cust_protokoll_replagal_daten:PRD_DOSIERUNG_AMP");
        DBMap.put(txt_adm_replagal_vol, "cust_protokoll_replagal_daten:PRD_INFUSIONS_VOL");

        DBMap.put(txt_inf_time_start, "cust_protokoll_replagal_daten:PRD_INFUSION_START");
        DBMap.put(txt_inf_time_stop, "cust_protokoll_replagal_daten:PRD_INFUSION_STOP");
        DBMap.put(txt_inf_rate, "cust_protokoll_replagal_daten:PRD_INFUSION_RATE");
        DBMap.put(txt_inf_total_duration, "cust_protokoll_replagal_daten:PRD_GESAMT_INFUSION_DAUER");

        DBMap.put(txt_vitals_time_start, "cust_protokoll_replagal_daten:PRD_VZ_START_UHRZEIT");
        DBMap.put(txt_vitals_pressure_start, "cust_protokoll_replagal_daten:PRD_VZ_START_DRUCK");
        DBMap.put(txt_vitals_mad_start, "cust_protokoll_replagal_daten:PRD_VZ_START_MAD");
        DBMap.put(txt_vitals_pulse_start, "cust_protokoll_replagal_daten:PRD_VZ_START_PULS");
        DBMap.put(txt_vitals_temp_start, "cust_protokoll_replagal_daten:PRD_VZ_START_TEMP");
        // DBMap.put(ta, "cust_protokoll_replagal_daten:PRD_VZ_START_KOMMENTAR");
        DBMap.put(txt_vitals_time_end, "cust_protokoll_replagal_daten:PRD_VZ_ENDE_UHRZEIT");
        DBMap.put(txt_vitals_pressure_end, "cust_protokoll_replagal_daten:PRD_VZ_ENDE_DRUCK");
        DBMap.put(txt_vitals_mad_end, "cust_protokoll_replagal_daten:PRD_VZ_ENDE_MAD");
        DBMap.put(txt_vitals_pulse_end, "cust_protokoll_replagal_daten:PRD_VZ_ENDE_PULS");
        DBMap.put(txt_vitals_temp_end, "cust_protokoll_replagal_daten:PRD_VZ_ENDE_TEMP");
        // DBMap.put(ta, "cust_protokoll_replagal_daten:PRD_VZ_ENDE_KOMMENTAR");
        DBMap.put(txt_vitals_time_reaction, "cust_protokoll_replagal_daten:PRD_VZ_REAKT_UHRZEIT");
        DBMap.put(txt_vitals_pressure_reaction, "cust_protokoll_replagal_daten:PRD_VZ_REAKT_DRUCK");
        DBMap.put(txt_vitals_mad_reaction, "cust_protokoll_replagal_daten:PRD_VZ_REAKT_MAD");
        DBMap.put(txt_vitals_pulse_reaction, "cust_protokoll_replagal_daten:PRD_VZ_REAKT_PULS");
        DBMap.put(txt_vitals_temp_reaction, "cust_protokoll_replagal_daten:PRD_VZ_REAKT_TEMP");

        DBMap.put(ta_vitals_pressure, "cust_protokoll_replagal_daten:PRD_VZ_DRUCK_KOMMENTAR");
        DBMap.put(ta_vitals_mad, "cust_protokoll_replagal_daten:PRD_VZ_MAD_KOMMENTAR");
        DBMap.put(ta_vitals_pulse, "cust_protokoll_replagal_daten:PRD_VZ_PULS_KOMMENTAR");
        DBMap.put(ta_vitals_temp, "cust_protokoll_replagal_daten:PRD_VZ_TEMP_KOMMENTAR");

        DBMap.put(ns_reaction_today, "cust_protokoll_replagal_daten:PRD_INFUSIONS_REAKTION_HEUTE");
        DBMap.put(ns_reaction_recent, "cust_protokoll_replagal_daten:PRD_INFUSIONS_REAKTION_VERG");
//        DBMap.put(txt_reaction_today_intensitiy, "cust_protokoll_replagal_daten:PRD_INFUSIONS_REAKTION_HEUTE_GRAD");
//        DBMap.put(txt_reaction_recent_intensity, "cust_protokoll_replagal_daten:PRD_INFUSIONS_REAKTION_VERG_GRAD");
        DBMap.put(cbx_reaction_today_intensity, "cust_protokoll_replagal_daten:PRD_INFUSION_REACTION_TODAY_INTENSITY");
        DBMap.put(cbx_reaction_recent_intensity, "cust_protokoll_replagal_daten:PRD_INFUSION_REACTION_RECENT_INTENSITY");
        DBMap.put(ta_reaction_today_desc, "cust_protokoll_replagal_daten:PRD_INFUSIONS_REAKTION_HEUTE_BESCHR");
        DBMap.put(ta_reaction_recent_desc, "cust_protokoll_replagal_daten:PRD_INFUSIONS_REAKTION_VERG_BESCHR");
        DBMap.put(txt_remaining_patient, "cust_protokoll_replagal_daten:PRD_AMP_PATIENT");
        DBMap.put(txt_remaining_nurse, "cust_protokoll_replagal_daten:PRD_AMP_NURSE");

        DBMap.put(txta_bemerkungen, "cust_protokoll_replagal_daten:PRD_BESONDERHEIT");
        DBMap.put(txta_beobachtungen, "cust_protokoll_replagal_daten:PRD_BEOBACHTUNGEN");

        DBMap.put(txt_port_details, "cust_protokoll_replagal_daten:PRD_PORT_DETAILS");
        DBMap.put(txt_port_block, "cust_protokoll_replagal_daten:PRD_PORT_BLOCK");
        
        DBMap.put(fieldBalanceWasRemoved, "cust_protokoll_replagal_daten:PRD_BALANCE_WAS_REMOVED");
        DBMap.put(productSource, "cust_protokoll_replagal_daten:PRD_PRODUCT_SOURCE");
        
        DBMap.put(cbx_prescribed_dose, "cust_protokoll_replagal_daten:PRD_PRESCRIBED_DOSE_ADM");
        DBMap.put(txt_prescribed_dose_reason, "cust_protokoll_replagal_daten:PRD_PRESCRIBED_DOSE_REASON");
        
        DBMap.put(cbx_caused_by, "cust_protokoll_replagal_daten:PRD_INFUSIONSREAKTION_ZUSAMMENHANG");
        DBMap.put(cbx_correlation, "cust_protokoll_replagal_daten:PRD_INFUSIONSREAKTION_ZUSAMMENHANG_BEWERTUNG");
    }
    ...
    private void Forms_Fill() {
        ...
        /******************************** Table ****************************************/
        db.DB_Data_Get.DB_Tabellen.DB_set_Tabelle_Einzeln("cust_protokoll_replagal_daten");
        /******************************************************************************/
        /******************************** Filter ****************************************/
        db.DB_Data_Get.DB_Filter.DB_WHERE_Allgemein("cust_protokoll_replagal_daten", "PRD_ID", "=", Form_ID, "");
        /******************************************************************************/
        ...
        fieldBalanceWasRemoved.setValue((Integer) con.getContainerProperty(con.getItemIds().iterator().next(), "PRD_BALANCE_WAS_REMOVED").getValue());
    ...
    private Container dbGetCharges() {
        ...
        db.DB_Data_Get.DB_Tabellen.DB_set_Tabelle_Einzeln("cust_protokoll_replagal_chargen");
        db.DB_Data_Get.DB_Spalten.Standard.DB_set_Spalten_Einzeln("*");
        db.DB_Data_Get.DB_Spalten.Standard.DB_set_Spalten_Einzeln("CONCAT(PRC_COUNT, 'x ', PRC_NR)", "display");
        db.DB_Data_Get.DB_Filter.DB_WHERE_Allgemein("cust_protokoll_replagal_chargen", "PRC_PRD_ID", "=", Form_ID, "");
        db.DB_Data_Get.DB_Ordnen.DB_Ordnen("PRC_NR", "ASC");
    ...
    private void updateCharges() {
        ...
        for (Object dbId : inDb.getItemIds()) {
            hashDb.put((String) inDb.getContainerProperty(dbId, "PRC_NR").getValue(), dbId);
        }

        for (Object listId : inList.getItemIds()) {
            hashList.put((String) inList.getContainerProperty(listId, "PRC_NR").getValue(), listId);
        }
        ...
        db.DB_Data_Insert.DB_Tabellen.DB_set_Tabelle_Einzeln("cust_protokoll_replagal_chargen");
        ...
        if (diff.entriesOnlyOnLeft().size() > 0) {
            for (Entry<String, Object> e : diff.entriesOnlyOnLeft().entrySet()) {
                ...
                db.DB_Data_Insert.DB_Daten.DB_Data("cust_protokoll_replagal_chargen", "PRC_PRD_ID", Form_ID);
                db.DB_Data_Insert.DB_Daten.DB_Data("cust_protokoll_replagal_chargen", "PRC_NR", (String) inList.getItem(e.getValue()).getItemProperty("PRC_NR")
                        .getValue());
                db.DB_Data_Insert.DB_Daten.DB_Data("cust_protokoll_replagal_chargen", "PRC_COUNT",
                        Integer.toString((Integer) inList.getItem(e.getValue()).getItemProperty("PRC_COUNT").getValue()));
        ...
        db.DB_Data_Delete.DB_Tabellen.DB_set_Tabelle_Einzeln("cust_protokoll_replagal_chargen");
        db.DB_Data_Get.DB_Tabellen.DB_set_Tabelle_Einzeln("cust_protokoll_replagal_chargen");
        ...
        if (diff.entriesOnlyOnRight().size() > 0) {
            for (Entry<String, Object> e : diff.entriesOnlyOnRight().entrySet()) {
                ...
                db.DB_Data_Delete.DB_Filter.DB_WHERE_Allgemein("cust_protokoll_replagal_chargen", "PRC_PRD_ID", "=", Form_ID, "AND");
                db.DB_Data_Delete.DB_Filter.DB_WHERE_Allgemein("cust_protokoll_replagal_chargen", "PRC_NR", "=", "'"
                        + (String) inDb.getItem(e.getValue()).getItemProperty("PRC_NR").getValue() + "'", "");
    ...
    private Integer toInt(TextField tf){
        ...
        if (tf.getValue() != null && !tf.getValue().toString().trim().equals("")){
            i = Integer.parseInt(tf.getValue().replaceAll( "[,.]", "."));
        }
    ...
    private void removeBalance(){
        ...
        Integer amp = toInt(txt_adm_replagal_amp);
...
//                    System.out.println("adjusting " + diff);
    ...
    private void adjustBalance(Integer delta){
        ...
        balance.editBalance(1, delta, StockPatientBalance.INFUSION);
    }
    ...
    private int Forms_Insert() {
        ...
        // dba.DB_Data_Insert.DB_Daten.DB_Data("cust_protokoll_replagal_daten", "PRD_ARZT_ID", Get_A_ID());

        /******************************** Table ****************************************/
        dba.DB_Data_Insert.DB_Tabellen.DB_set_Tabelle_Einzeln("cust_protokoll_replagal_daten");
        /******************************************************************************/
    ...
    private void Forms_Update() {
        ...
        /******************************** Table ****************************************/
        db.DB_Data_Update.DB_Tabellen.DB_set_Tabelle_Einzeln("cust_protokoll_replagal_daten");
        /******************************************************************************/
        /******************************** Filter ****************************************/
        db.DB_Data_Update.DB_Filter.DB_WHERE_Allgemein("cust_protokoll_replagal_daten", "PRD_ID", "=", Form_ID, "");
        /******************************************************************************/
    ...
    private Boolean isHomecare(){
        DBClass db = new DBClass();
        db.DB_Data_Get.DB_Spalten.Standard.DB_set_Spalten_Einzeln("PREPMD_HOMECARE");
        db.DB_Data_Get.DB_Tabellen.DB_set_Tabelle_Verknüpfung("cust_protokoll_replagal_daten", "LEFT JOIN", "cust_protokoll_replagal_meta_dynamic", "PRD_DELEGATION_ID", "PREPMD_ID");
        db.DB_Data_Get.DB_Filter.DB_WHERE_Allgemein("cust_protokoll_replagal_daten", "PRD_ID", "=", Form_ID, "");
        
        Item item = db.DB_Data_Get.DB_SEND_AND_GET_FIRST_ITEM();
        
        return (item != null && item.getItemProperty("PREPMD_HOMECARE") != null  &&
                MyUtils.equalsWithNulls(item.getItemProperty("PREPMD_HOMECARE").getValue(), true)
                );
    }
    ...
    private void getInitials() {
        ...
        q.setSqlString("select PREPMS_PAT_INITIALS"
             + "\n " + "from cust_protokoll_replagal_daten"
             + "\n " + "left join cust_protokoll_replagal_meta_dynamic on PRD_DELEGATION_ID = PREPMD_ID"
             + "\n " + "left join cust_protokoll_replagal_meta_static on PREPMD_VH_ID = PREPMS_VH_ID"
             + "\n " + "where PRD_ID = " + Form_ID
                 + "");
//        db.debugNextQuery(true);
        
        txt_initials.setValue(MyUtils.getValueFromItem(MyUtils.getFirstItemFromContainer(q.query()), "PREPMS_PAT_INITIALS", String.class));
    }
    ...
    private void fillNurseCombo() {
        ...
        ReplagalNurseCombos rnc = new ReplagalNurseCombos();
        rnc.setPatientId((Integer) cb_pat.getValue());
        
        try {
            
            new combo(rnc.getNurseComboSubs(), cb_nurse, "KSK_ID", "Krankenschwesternname");
            new combo(rnc.getNurseComboMain(), cb_nurse, "KSK_ID", "Krankenschwesternname");
    ...
    private void fillLngType() {
        ...
        I18nConverter lc = new I18nConverter("cust_protokoll_replagal_typ", "PRT_ID", "PRT_STRING");
    ...
    private void Set_Validate_Map() {
        ...
        ValidateMap.put(txt_adm_replagal_vol, "txt_adm_replagal_vol");
        ...
        ValidateMap.put(txt_adm_replagal_amp, "txt_adm_replagal_amp");
    ...
    private void Fill_ns_P_Status_Nurse() {
        ...
        db.DB_Data_Get.DB_Filter.DB_WHERE_Allgemein("cust_schulung_status", "SS_PROJEKT", "=", "2", "AND");
    ...
    private void Fill_ns_P_Status() {
        ...
        db.DB_Data_Get.DB_Filter.DB_WHERE_Allgemein("cust_schulung_status", "SS_PROJEKT", "=", "2", "");
    ...
    private void Fill_cb_P_Patient_nurse() {
        ...
        db.DB_Data_Get.DB_Filter.DB_WHERE_Allgemein("cust_verk_haupt", "VH_PROJEKT_ID", "=", "2", "");
        ...
        //db.DB_Data_Get.DB_Filter.DB_WHERE_Allgemein("cust_verk_subs", "CVS_PROJECT_ID", "=", "2", ")");
    ...
    private void fillNeedles(Boolean filtered) {
        ...
        cbx_needle.setNewItemsAllowed(false);
...
//    }
    ...
    private void fillReactionSelect() {
        ...
        for (Label l : labels) {
            ...
            // ns_reaction_today.setNullSelectionItemId(-1);
            ns_reaction_today.addItem(l.getValue());
            ns_reaction_today.setItemCaption(l.getValue(), l.getCaption());

            ns_reaction_recent.setNullSelectionAllowed(true);
            // ns_reaction_recent.setNullSelectionItemId(-1);
            ns_reaction_recent.addItem(l.getValue());
            ns_reaction_recent.setItemCaption(l.getValue(), l.getCaption());
            
            cbx_caused_by.setNullSelectionAllowed(true);
            cbx_caused_by.addItem(Integer.parseInt(l.getValue()));
            cbx_caused_by.setItemCaption(Integer.parseInt(l.getValue()), l.getCaption());
            
            cbx_prescribed_dose.setNullSelectionAllowed(true);
            cbx_prescribed_dose.addItem(Integer.parseInt(l.getValue()));
            cbx_prescribed_dose.setItemCaption(Integer.parseInt(l.getValue()), l.getCaption());
        }
...
//                    System.out.println("adding validator");
                    txt_adm_replagal_amp.addValidator(balanceValidator);
                }else{
//                    System.out.println("removing validator");
                    txt_adm_replagal_amp.removeValidator(balanceValidator);
                }
    ...
    private DBClass generateBaseTicketQuery(Boolean glue){
    	
    	DBClass db = new DBClass();
    	
    	db.DB_Data_Get.DB_Spalten.Standard.DB_set_Spalten_Einzeln("*");
    	db.DB_Data_Get.DB_Spalten.Standard.DB_set_Spalten_Einzeln("date_add(OMT_DELIVERY_DATE, INTERVAL 1 DAY)", "min_date_current");
    	db.DB_Data_Get.DB_Spalten.Standard.DB_set_Spalten_Einzeln("date_add(OMT_DATE_UNTIL, INTERVAL 1 DAY)", "min_date_previous");
    	
    	db.DB_Data_Get.DB_Tabellen.DB_set_Tabelle_Verknüpfung("cust_ordermanager_orders", "INNER JOIN", "cust_ordermanager_tickets", "OMO_ID", "OMT_ID_ORDER");
    	db.DB_Data_Get.DB_Tabellen.DB_set_Tabelle_Verknüpfung("cust_ordermanager_tickets", "INNER JOIN", "cust_ordermanager_ticket_contents", "OMT_ID", "OMTC_ID_TICKET");
    	db.DB_Data_Get.DB_Tabellen.DB_set_Tabelle_Verknüpfung("cust_ordermanager_tickets", "INNER JOIN", "cust_ordermanager_master_status", "OMT_ID_STATUS", "OMMS_ID");
    	
    	db.DB_Data_Get.DB_Filter.DB_WHERE_Allgemein("cust_ordermanager_orders", "OMO_ID_PROJECT", "=", "2", glue ? "AND" : "");
    	
    	return db;
    }
    
    private void dbGetProtocolOrderStatus() {
    	
    	DBClass db = generateBaseTicketQuery(true);
    	db.DB_Data_Get.DB_Filter.DB_WHERE_Allgemein("cust_ordermanager_ticket_contents", "OMTC_ID_DATA", "=", Form_ID, "");
    	
    	db.debugNextQuery(false);
    	
    	orderItem = db.DB_Data_Get.DB_SEND_AND_GET_FIRST_ITEM();

    }
    
    private Date dbGetProtocolOrderPrevious() {
    	
    	DBClass db = generateBaseTicketQuery(true);
    	
//    	db.DB_Data_Get.DB_Filter.DB_WHERE_Allgemein("cust_ordermanager_tickets", "OMT_DATE_UNTIL", "<", pop_date.getValue, "");
    	
    	
        if(pop_date.getValue() != null){
            
            java.sql.Timestamp sqlDate = new java.sql.Timestamp(new LocalDate(pop_date.getValue()).toDate().getTime());
            
            db.DB_Data_Get.DB_Filter.DB_WHERE_Allgemein("cust_ordermanager_tickets", "OMT_DATE_UNTIL", "<", " '" + sqlDate.toString() + "' ", "");
        }
    	
    	
    	db.DB_Data_Get.DB_Ordnen.DB_Ordnen("OMT_DATE_UNTIL", "DESC");
		...
		if(item != null){
			java.sql.Date ts = (java.sql.Date) item.getItemProperty("min_date_previous").getValue();
    ...
    private VerticalLayout buildMainLayout() {
        ...
        mainLayout.setExpandRatio(horizontalLayout_3, 5.0f);
    ...
    private HorizontalLayout buildHorizontalLayout_7() {
        ...
        ns_status.setCaption("Protokolle Status");
    ...
    private VerticalLayout buildVerticalLayout_22() {
        ...
        verticalLayout_22.setExpandRatio(gridLayout_3, 7.0f);
    ...
    private GridLayout buildGridLayout_3() {
        ...
        // lbl_replagal
        lbl_replagal = new Label();
        lbl_replagal.setStyleName("v-panel-caption");
        lbl_replagal.setImmediate(false);
        lbl_replagal.setWidth("-1px");
        lbl_replagal.setHeight("-1px");
        lbl_replagal.setValue("Replagal verabreicht");
        gridLayout_3.addComponent(lbl_replagal, 0, 0);
        gridLayout_3.setComponentAlignment(lbl_replagal, new Alignment(33));
        ...
        // lbl_adm_replagal_vol
        lbl_adm_replagal_vol = new Label();
        lbl_adm_replagal_vol.setStyleName("v-panel-caption");
        lbl_adm_replagal_vol.setImmediate(false);
        lbl_adm_replagal_vol.setWidth("-1px");
        lbl_adm_replagal_vol.setHeight("-1px");
        lbl_adm_replagal_vol.setValue("Gesamt-Infusionsvolumen");
        gridLayout_3.addComponent(lbl_adm_replagal_vol, 0, 1);
        gridLayout_3.setComponentAlignment(lbl_adm_replagal_vol, new Alignment(33));
    ...
    private HorizontalLayout buildHl_repl() {
        ...
        // txt_adm_replagal_mg
        txt_adm_replagal_mg = new TextField();
        txt_adm_replagal_mg.setImmediate(false);
        txt_adm_replagal_mg.setWidth("64px");
        txt_adm_replagal_mg.setHeight("-1px");
        hl_repl.addComponent(txt_adm_replagal_mg);
        hl_repl.setComponentAlignment(txt_adm_replagal_mg, new Alignment(33));
        
        // lbl_mg
        lbl_mg = new Label();
        lbl_mg.setImmediate(false);
        lbl_mg.setWidth("-1px");
        lbl_mg.setHeight("-1px");
        lbl_mg.setValue("mg");
        hl_repl.addComponent(lbl_mg);
        hl_repl.setComponentAlignment(lbl_mg, new Alignment(33));
        
        // txt_adm_replagal_amp
        txt_adm_replagal_amp = new TextField();
        txt_adm_replagal_amp.setImmediate(false);
        txt_adm_replagal_amp.setWidth("64px");
        txt_adm_replagal_amp.setHeight("-1px");
        hl_repl.addComponent(txt_adm_replagal_amp);
        hl_repl.setComponentAlignment(txt_adm_replagal_amp, new Alignment(33));
    ...
    private HorizontalLayout buildHl_rep_total() {
        ...
        // txt_adm_replagal_vol
        txt_adm_replagal_vol = new TextField();
        txt_adm_replagal_vol.setImmediate(false);
        txt_adm_replagal_vol.setWidth("64px");
        txt_adm_replagal_vol.setHeight("-1px");
        hl_rep_total.addComponent(txt_adm_replagal_vol);
        hl_rep_total.setComponentAlignment(txt_adm_replagal_vol, new Alignment(33));
    ...
    private VerticalLayout buildLayout_prescribed_dose() {
        ...
        layout_prescribed_dose.setHeight("-1px");
        layout_prescribed_dose.setMargin(false);
        
        // cbx_prescribed_dose
        cbx_prescribed_dose = new ComboBox();
        cbx_prescribed_dose.setImmediate(false);
        cbx_prescribed_dose.setWidth("-1px");
        cbx_prescribed_dose.setHeight("-1px");
        layout_prescribed_dose.addComponent(cbx_prescribed_dose);
    ...
    private VerticalLayout buildVerticalLayout_10() {
        ...
        verticalLayout_10.addComponent(lbl_spot);
        
        // gridLayout_4
        gridLayout_4 = buildGridLayout_4();
        verticalLayout_10.addComponent(gridLayout_4);
        verticalLayout_10.setExpandRatio(gridLayout_4, 1.0f);
    ...
    private HorizontalLayout buildHorizontalLayout_27() {
        ...
        // lbl_caused_by
        lbl_caused_by = new Label();
        lbl_caused_by.setImmediate(false);
        lbl_caused_by.setWidth("-1px");
        lbl_caused_by.setHeight("-1px");
        lbl_caused_by.setValue("Kausaler Zusammenhang zu Replagal");
        horizontalLayout_27.addComponent(lbl_caused_by);
        horizontalLayout_27.setComponentAlignment(lbl_caused_by, new Alignment(48));
        
        // cbx_caused_by
        cbx_caused_by = new ComboBox();
        cbx_caused_by.setImmediate(false);
        cbx_caused_by.setWidth("-1px");
        cbx_caused_by.setHeight("-1px");
        horizontalLayout_27.addComponent(cbx_caused_by);
        horizontalLayout_27.setComponentAlignment(cbx_caused_by, new Alignment(48));
        ...
        horizontalLayout_27.setComponentAlignment(lbl_correlation, new Alignment(48));
        ...
        horizontalLayout_27.setComponentAlignment(cbx_correlation, new Alignment(48));
