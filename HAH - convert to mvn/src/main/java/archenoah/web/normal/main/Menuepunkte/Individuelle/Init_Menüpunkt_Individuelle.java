...
//        Stammdaten.addItem("INDV_Stammdaten_Pharmafirmen", Icons.Black.pharma_16, null);
    ...
    public void Menü_Projekte() {
        ...
        Projekte_verwaltung.addItem("INDV_Viewzuweisung", Icons.Black.berechtigung_16, cmd.Viewzuweisung);
        ...
        Projekte.addItem("INDV_Reporting", Icons.Black.dev_16, cmd.Reporting);
    }
