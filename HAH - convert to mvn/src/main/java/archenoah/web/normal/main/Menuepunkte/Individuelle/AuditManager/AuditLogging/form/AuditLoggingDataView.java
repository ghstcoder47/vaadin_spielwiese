...
import archenoah.web.normal.main.Menuepunkte.Individuelle.AuditManager.AuditLogging.classes.AuditPdfPrint;
...
public class AuditLoggingDataView extends CustomComponent {
    ...
    /************ ----->Einstellungen<-- ********************/
//    private final String formIdLng = "501";
    ...
    //TASK cols
    private final Object[] tableColsAll = new Object[] { "ALL_ID", "ALL_CREATED",  "ALL_DATE", "ALT_NAME", "ALD_NAME", "ALL_TIME_START", "ALL_TIME_END", "ALL_AUDITOR" };
    ...
    public AuditLoggingDataView(MenuItem Arg_Menü) {
        tmpMenu = Arg_Menü;
    }

    public AuditLoggingDataView(Button Arg_btn) {
        tmpButton = Arg_btn;
    }
    ...
    public ClickCommand cmd_btn_add = new ClickCommand() {
        ...
        public void menuClicked(MenuItem selectedItem) {
        	...
        	AuditLoggingInsertEdit pie = new AuditLoggingInsertEdit(selectedItem, "");
    ...
    public ClickCommand cmd_btn_read = new ClickCommand() {
        ...
        public void menuClicked(MenuItem selectedItem) {
            ...
            AuditLoggingInsertEdit pie = new AuditLoggingInsertEdit(selectedItem, getSelectedValue());
    ...
    private void configureComponents(){
        ...
        AuditPdfPrint print = new AuditPdfPrint(tbl_data);
...
//        }
    ...
    private void configureTable() {
        ...
        if(tbl_data.size() > 0){
            ...
            tbl_data.setConverter("ALL_DATE", date);
            tbl_data.setConverter("ALL_CREATED", datetime);
            
            tbl_data.setConverter("ALL_TIME_START", time);
            tbl_data.setConverter("ALL_TIME_END", time);
            
        
        }
        
        tableUpdater = new FilteringTableUpdater(tbl_data);
        tableUpdater.showSum("ALL_AUDITOR");
        ...
        tbl_data.setColumnExpandRatio("ALL_ID", 0);
        tbl_data.setColumnExpandRatio("ALL_DATE", 1);

        tbl_data.setColumnExpandRatio("ALL_TIME_START", 0);
        tbl_data.setColumnExpandRatio("ALL_TIME_END", 0);
        
        tbl_data.setColumnExpandRatio("ALL_AUDITOR", 1);
	...
	private void dbGetContainer() {
        ...
        /**************************************/
        /************ Set Tabelle *************/
//        db.DB_Data_Get.DB_Tabellen.DB_set_Tabelle_Einzeln("cust_audit_logging_logs");
        
        db.DB_Data_Get.DB_Tabellen.DB_set_Tabelle_Verknüpfung("cust_audit_logging_type", "RIGHT JOIN", "cust_audit_logging_logs", "ALT_ID", "ALL_ID_TYPE");
        db.DB_Data_Get.DB_Tabellen.DB_set_Tabelle_Verknüpfung("cust_audit_logging_division", "RIGHT JOIN", "cust_audit_logging_logs", "ALD_ID", "ALL_ID_DIVISION");
//        db.DB_Data_Get.DB_Tabellen.DB_set_Tabelle_Verknüpfung("cust_taskmanager_meeting_groups", "RIGHT JOIN", "cust_audit_logging_logs", "TMEG_ID", "TMEL_ID_TEAM");
//        
//        
        /**************************************/
        /************ Set Filter *************/
...
//        }
        ...
        db.DB_Data_Get.Set_Type("ALL_TIME_START", Time.class);
        db.DB_Data_Get.Set_Type("ALL_TIME_END", Time.class);
...
//        db.debugNextQuery(true);
    ...
    private void dbDeleteData(String id){
        ...
        DBClass db = new DBClass();
        db.DB_Data_Delete.DB_Tabellen.DB_set_Tabelle_Einzeln("cust_audit_logging_logs");
        db.DB_Data_Delete.DB_Filter.DB_WHERE_Allgemein("cust_audit_logging_logs", tableIdCol, "=", id, "");
