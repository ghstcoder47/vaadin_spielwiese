...
public class ProjectLeadsDataView extends CustomComponent {
    ...
    private final String tableIdCol = "SPL_ID";
    
    //TASK cols
    private final Object[] tableColsAll = new Object[] {"SPL_ID", "SPL_ID_USER", "SPL_ID_PROJEKT"};
    ...
    public ProjectLeadsDataView(MenuItem Arg_Menü) {
        tmpMenu = Arg_Menü;
    }

    public ProjectLeadsDataView(Button Arg_btn) {
        tmpButton = Arg_btn;
    }
    ...
    public Command cmd_btn_add = new ClickCommand() {
        ...
        public void menuClicked(MenuItem selectedItem) {
            ...
            ProjectLeadsInsertEdit pie = new ProjectLeadsInsertEdit(btn_create, null);
            pie.setPermissions(permCreate, permRead, permUpdate, permDelete);
            pie.setProjects(projectConverter);
    ...
    public Command cmd_btn_read = new ClickCommand() {
        ...
        public void menuClicked(MenuItem selectedItem) {
            ...
            ProjectLeadsInsertEdit pie = new ProjectLeadsInsertEdit(selectedItem, getSelectedId());
...
//            tbl_data.addGeneratedColumn("rx", new HtmlLabelColumnGenerator("rx", "rx_raw"));
        ...
        gen.addConverter("SPL_ID_PROJEKT", projectConverter);
        gen.addConverter("SPL_ID_USER", userConverter);
        gen.attach(tbl_data);
        ...
        tableUpdater.showSum("SPL_ID_PROJEKT"); 
...
//        btn_create.setEnabled(crud);
	...
	private void dbGetContainer() {
        ...
        String sql = "select * from cust_stammdaten_projektleiter";
        q.setSqlString(sql);
    ...
    private void dbDeleteData(Collection<Integer> ids){
        ...
        db.DB_Data_Delete.DB_Tabellen.DB_set_Tabelle_Einzeln("cust_stammdaten_projektleiter");
        db.DB_Data_Delete.DB_Filter.DB_WHERE_In("cust_stammdaten_projektleiter", tableIdCol, Joiner.on(",").join(ids), "");
    ...
    public static class ProjectConverter implements DataviewConverter<Integer>, TableFilterConverter{

        static final String caption = "PSLV_NAME";
        ...
        public ProjectConverter() {
            ...
            con = MyUtils.convertIndex(q.query(), "PSLV_ID");
    ...
    public static class UserConverter implements DataviewConverter<Integer>, TableFilterConverter{
        ...
        public UserConverter() {
            ...
            String sql = "select AUL_ID, CONCAT_WS(' ',"
                 ...
                 + "\n " + "inner join cms_auth_liste_gu on AUL_ID = AL_U_ID"
                 + "\n " + "where AL_G_ID = 12"
