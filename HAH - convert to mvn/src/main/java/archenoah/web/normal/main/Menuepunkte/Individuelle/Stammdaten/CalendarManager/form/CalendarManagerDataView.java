...
public class CalendarManagerDataView extends CustomComponent {
    ...
    /************ ----->Einstellungen<-- ********************/
//    private final String formIdLng = "90";
    ...
    private final String tableIdCol = "CD_ID";
    
    //TASK cols
    private final Object[] tableColsAll = new Object[] {"CD_DATE_START", "CD_DATE_END", "CD_COUNTRY", "CD_TYPE", "CD_TITLE", "CD_COMMENT"};
    ...
    public CalendarManagerDataView(MenuItem Arg_Menü) {
        tmpMenu = Arg_Menü;
    }

    public CalendarManagerDataView(Button Arg_btn) {
        tmpButton = Arg_btn;
    }
    ...
    public Command cmd_btn_add = new Command() {
        ...
        public void menuSelected(MenuItem selectedItem) {
          ...
          CalendarManagerInsertEdit pie = new CalendarManagerInsertEdit(btn_update, "");
    ...
    public Command cmd_btn_read = new ClickCommand() {
        ...
        public void menuClicked(MenuItem selectedItem) {
            ...
            CalendarManagerInsertEdit pie = new CalendarManagerInsertEdit(selectedItem, getSelectedValue());
    ...
    private void configureTable() {
        ...
        if(tbl_data.size() > 0){
            ...
            tbl_data.setConverter("CD_DATE_START", date);
            tbl_data.setConverter("CD_DATE_END", date);
            
            I18nConverter typeConverter = new I18nConverter("cust_calendar_dates_types", "CDT_KEY", "CDT_KEY");
            tbl_data.setConverter("CD_TYPE", typeConverter);
...
//        q.db.debugNextQuery(true);
    ...
    private void dbDeleteData(Collection<Integer> ids){
        ...
        db.DB_Data_Delete.DB_Tabellen.DB_set_Tabelle_Einzeln("cust_calendar_dates");
        db.DB_Data_Delete.DB_Filter.DB_WHERE_In("cust_calendar_dates", tableIdCol, Joiner.on(",").join(ids), "");
