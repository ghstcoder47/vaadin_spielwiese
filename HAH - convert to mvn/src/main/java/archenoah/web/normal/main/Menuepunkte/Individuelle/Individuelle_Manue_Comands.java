...
import archenoah.web.normal.main.Menuepunkte.Individuelle.Projekte.Reporting.initReporting;
import archenoah.web.normal.main.Menuepunkte.Individuelle.Projekte.Stock.StockManager.initStockManager;
import archenoah.web.normal.main.Menuepunkte.Individuelle.Projekte.Viewzuweisung.initRportingPermissions;
...
public class Individuelle_Manue_Comands {
    ...
    public Command Projektzuweisungsverwverwaltung = new Command() {
        ...
        public void menuSelected(MenuItem selectedItem) {
            // TODO Auto-generated method stub
            I18nManager.clearManagers();
            initRportingPermissions ik = new initRportingPermissions(selectedItem);
        }
    };
    ...
    public Command Reporting = new Command(){

		@Override
		public void menuSelected(MenuItem selectedItem) {
			// TODO Auto-generated method stub
    		I18nManager.clearManagers();
    		initReporting ik = new initReporting(selectedItem);
		}
    };
    
    public Command Viewzuweisung = new Command(){
