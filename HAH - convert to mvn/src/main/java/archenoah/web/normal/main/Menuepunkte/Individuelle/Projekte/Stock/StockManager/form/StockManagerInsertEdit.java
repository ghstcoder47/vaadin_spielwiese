...
public class StockManagerInsertEdit extends CustomComponent {
    ...
    /************ ----->Einstellungen<-- ********************/
//    private final String formIdLng = "212";
    private final String formIdPerm = "212";
...
//    private final String dataTableName = "cust_XX";
    ...
    public StockManagerInsertEdit(MenuItem Arg_Menü, String Arg_Form_ID) {
        tmpMenu = Arg_Menü;
        dataSetId = Arg_Form_ID;
    }

    public StockManagerInsertEdit(Button Arg_btn, String Arg_Form_ID) {
        tmpButton = Arg_btn;
        dataSetId = Arg_Form_ID;
    }
...
//                }
    ...
    private void updateBalance(){
        ...
        balance.editBalance((Integer) fieldProduct.getValue(), fieldDelta.getValue(), StockPatientBalance.MANUAL);
    }
...
//        ValidateMap.put(component, "component"); // should not be needed
    ...
    private VerticalLayout buildMain() {
        ...
        main.setExpandRatio(panelData, 3.0f);
