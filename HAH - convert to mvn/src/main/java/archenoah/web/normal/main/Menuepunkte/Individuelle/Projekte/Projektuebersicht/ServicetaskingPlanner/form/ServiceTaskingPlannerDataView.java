...
public class ServiceTaskingPlannerDataView extends CustomComponent {
    ...
    /**************** --> Allgemein <--- ********************/
    // Sprache
//    public HashMap<Object, String> lngMap;
//    private LNG_Label LC;
    ...
    private final String tableIdCol = "STPL_ID";
    
    //TASK cols
    private final Object[] tableColsAll = new Object[] {"STPL_ID", "PSLV_NAME", "STPL_NAME"};
    ...
    public ServiceTaskingPlannerDataView(MenuItem Arg_Menü) {
        tmpMenu = Arg_Menü;
    }

    public ServiceTaskingPlannerDataView(Button Arg_btn) {
        tmpButton = Arg_btn;
    }
    ...
    public Command cmd_btn_add = new Command() {
        ...
        public void menuSelected(MenuItem selectedItem) {
          ...
          ServiceTaskingPlannerInsertEdit pie = new ServiceTaskingPlannerInsertEdit(btn_create, "");
    ...
    public Command cmd_btn_read = new ClickCommand() {
        ...
        public void menuClicked(MenuItem selectedItem) {
            ...
            ServiceTaskingPlannerInsertEdit pie = new ServiceTaskingPlannerInsertEdit(selectedItem, getSelectedValue());
...
//            
////            LngConverter typeConverter = new LngConverter(601, "cust_protokoll_servicetasking_plans_master_types", "STXT_KEY", "STXT_KEY");
...
//        tbl_data.setColumnExpandRatio("ST_ID", 0);
	...
	private void dbGetContainer() {
        ...
        String sql = "select STPL_ID, PSLV_NAME, STPL_NAME from cust_protokoll_servicetasking_plans"
            + "\n " + "left join cust_projekte_stammdaten_liste on STPL_ID_PROJECT = PSLV_ID";
...
//        q.db.debugNextQuery(true);
    ...
    private void dbDeleteData(Collection<Integer> ids){
        ...
        db.DB_Data_Delete.DB_Tabellen.DB_set_Tabelle_Einzeln("cust_protokoll_servicetasking_plans");
        db.DB_Data_Delete.DB_Filter.DB_WHERE_In("cust_protokoll_servicetasking_plans", tableIdCol, Joiner.on(",").join(ids), "");
