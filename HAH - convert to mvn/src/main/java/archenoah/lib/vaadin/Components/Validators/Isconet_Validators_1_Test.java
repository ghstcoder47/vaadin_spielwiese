...
public class Isconet_Validators_1_Test { 
	...
	public Isconet_Validators_1_Test(String Arg_Formid,Map<Object, String> Arg_Validator_Map){
		...
		keys = Arg_Validator_Map.keySet();
		 ...
		 for (Object singleKey : keys) {
			 ...
			 Validatorname = Arg_Validator_Map.get(singleKey).toString();
			 
			 AF.addValidator(new BeanValidator(Validator, Validatorname));
