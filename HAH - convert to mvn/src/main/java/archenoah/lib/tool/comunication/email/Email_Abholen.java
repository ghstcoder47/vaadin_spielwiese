...
public class Email_Abholen {


	
	private String Server_Adresse;
	private String Server_Port;
	private String Server_Username;
	private String Server_Passwort;
	
	
	//Constructor Call
	public Email_Abholen(String SRV_Adresse,String SRV_Port,String SRV_Username,String SRV_Passwort) {
		
		Server_Adresse = SRV_Adresse;
		Server_Port    = SRV_Port;
		Server_Username    = SRV_Username;
		Server_Passwort    = SRV_Passwort;
	...
	public void processMail() {
	   ...
	   try {
	      ...
	      store.connect(Server_Adresse,Server_Username,Server_Passwort);
