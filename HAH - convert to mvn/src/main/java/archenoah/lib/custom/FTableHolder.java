 ...
 * 
 */
public class FTableHolder implements TableHolder{
	/**
	 * 
	 */
	private static final long serialVersionUID = -2394147985480880209L;
	...
	public FTableHolder(FilterTable table) {
        this.table = table;
    ...
    public Short getCellAlignment(Object propId) {
        final CustomTable.Align vaadinAlignment = table.getColumnAlignment(propId);
        return vaadinAlignmentToCellAlignment(vaadinAlignment);
    }

    private Short vaadinAlignmentToCellAlignment(final CustomTable.Align vaadinAlignment) {
        if (CustomTable.Align.LEFT.equals(vaadinAlignment)) {
            return CellStyle.ALIGN_LEFT;
        } else if (CustomTable.Align.RIGHT.equals(vaadinAlignment)) {
    ...
    public Property getPropertyForGeneratedColumn(final Object propId, final Object rootItemId) throws IllegalArgumentException {
        Property prop;
        final CustomTable.ColumnGenerator tcg = table.getColumnGenerator(propId);
