...
import archenoah.web.normal.main.Menuepunkte.Individuelle.Projekte.Projektuebersicht.replagal.classes.I18nREPStatus;
...
public class ReplagalDataView extends CustomComponent {
    ...
    /************ ----->Einstellungen<-- ********************/
//    private final String formIdLng = "37";
    private final String formIdPerm = "38";
    ...
    private final Object[] tableColsDefault = new Object[] { "ID", "rx", "Patient", "Land", "Arzt", "Krankenschwester", "Datum", "infType", "regionalManagerOk", "Regionalleiter", "Status" };
    ...
    private final static String downloadButtonID = "downloadPdf";
    ...
    public ReplagalDataView(MenuItem Arg_Menü) {
        tmpMenu = Arg_Menü;
    }

    public ReplagalDataView(Button Arg_btn) {
        tmpButton = Arg_btn;
    }
    ...
    public ClickCommand cmd_btn_add = new ClickCommand() {
        ...
        public void menuClicked(MenuItem selectedItem) {
            ...
            replagal_insert_edit pie = new replagal_insert_edit(selectedItem, Integer.toString(pid));
    ...
    public ClickCommand cmd_btn_read = new ClickCommand() {
        ...
        public void menuClicked(MenuItem selectedItem) {
            ...
            String id = getSelectedId().toString();
            replagal_insert_edit pie = new replagal_insert_edit(selectedItem, id + "");
            pie.Init_Class_Window();
    ...
    public ClickCommand cmd_btn_locateTicket = new ClickCommand() {
        ...
        public void menuClicked(MenuItem selectedItem) {
            ...
            this.setWindow(locator.locateContent(2, getSelectedId()));
            this.setParent(men_frm);
        }
    ...
    private void configueComponents(){
        ...
        new I18nREPStatus().attachDatasource(tcol_filterStatus);
        ...
        patientHistory = new PatientHistoryToggle("PRD_P_ID", "Patient", men_frm, tbl_data);
        patientHistory.setToggleListener(new ToggleListener() {
            ...
            public void onToggle(Integer pid) {
                ...
                cb_filterMonth.setValue(enableFilters);
                cb_filterStatus.setValue(enableFilters);
        ...
        ReplagalPdfPrint print = new ReplagalPdfPrint(tbl_data);
    ...
    private void configureTable() {
        ...
        if(tbl_data.size() > 0){
            ...
            gen.addConverter("infType", new I18nConverter("cust_protokoll_replagal_typ", "PRT_STRING"));
            gen.addConverter("Status", new I18nREPStatus());
            gen.attach(tbl_data);
    ...
    private Boolean isRegionalManager() {
        ...
        db.DB_Data_Get.DB_Filter.DB_WHERE_Allgemein("cust_stammdaten_regionalleiter", "SRL_ID_PROJEKT", "=", "2", "");
    ...
    private void dbGetContainer() {
        ...
        /************ Set Spalten *************/
        db.DB_Data_Get.DB_Spalten.Standard.DB_set_Spalten_Einzeln("PRD_ID");
//        db.DB_Data_Get.DB_Spalten.Standard.DB_set_Spalten_Einzeln("1", "Status");
        db.DB_Data_Get.DB_Spalten.Standard.DB_set_Spalten_Einzeln("PRD_ID", "ID");
        ...
        db.DB_Data_Get.DB_Spalten.Standard.DB_set_Spalten_Einzeln("PRD_P_ID");
        db.DB_Data_Get.DB_Spalten.Standard.DB_set_Spalten_Einzeln("PRD_K_ID"); // used by copy on add
        db.DB_Data_Get.DB_Spalten.Standard.DB_set_Spalten_Einzeln("PRD_DELEGATION_ID"); // used by copy on add
        db.DB_Data_Get.DB_Spalten.Standard.DB_set_Spalten_Einzeln("PRD_ARZT_ID"); // used by copy on add
        ...
        db.DB_Data_Get.DB_Spalten.Standard.DB_set_Spalten_Einzeln("ptype.PRT_STRING as infType");
        
        db.DB_Data_Get.DB_Spalten.Standard
                .DB_set_Spalten_Einzeln(
                        "CASE WHEN PRD_DATE > '1900-01-01 00:00:00' THEN DATE_ADD(PRD_DATE, INTERVAL IF(PRD_VON != '', PRD_VON, '') HOUR_MINUTE) END",
                        "'Datum'");
        
        db.DB_Data_Get.DB_Spalten.Standard.DB_set_Spalten_Einzeln("CASE when PRD_REGIONAL_MANAGER_OK = 0 then '" + i18n.get(caption.regionalManagerOkfalse) + "' else '" + i18n.get(caption.regionalManagerOktrue) + "' end", "'regionalManagerOk'");
        
        db.DB_Data_Get.DB_Spalten.Standard.DB_set_Spalten_Einzeln("PRD_STATUS", "'Status'");
        /**************************************/
        /************ Set Tabelle *************/
        db.DB_Data_Get.DB_Tabellen.DB_set_Tabelle_Verknüpfung("cust_protokoll_replagal_daten", "LEFT JOIN", "cust_patient_stammdaten_liste", "PRD_P_ID",
                "PSL_ID");
        db.DB_Data_Get.DB_Tabellen.DB_set_Tabelle_Verknüpfung("cust_patient_stammdaten_liste", "RIGHT JOIN", "cust_patient_stammdaten_anrede",
                "PSL_ANREDE", "PSA_ID");

        /* Krankenschwester */
        db.DB_Data_Get.DB_Tabellen.DB_set_Tabelle_Verknüpfung("cust_protokoll_replagal_daten", "RIGHT JOIN", "cust_krankenschwester_stammdaten_ks",
                "PRD_K_ID", "KSK_ID");

        /* Arzt */
        db.DB_Data_Get.DB_Tabellen.DB_set_Tabelle_Verknüpfung("cust_protokoll_replagal_daten", "RIGHT JOIN", "cust_arzt_stammdaten_arzt", "PRD_ARZT_ID",
                "ASA_ID");
        ...
        db.DB_Data_Get.DB_Tabellen.DB_set_Tabelle_Verknüpfung_Graph("LEFT JOIN", "cms_auth_stammdaten_user AS Arzt", "Arzt", "cust_arzt_stammdaten_arzt",
                "AUL_ID", "ASA_U_ID");
        db.DB_Data_Get.DB_Tabellen.DB_set_Tabelle_Verknüpfung_Graph("LEFT JOIN", "cms_auth_stammdaten_user AS Krankenschwester", "Krankenschwester",
                "cust_krankenschwester_stammdaten_ks", "AUL_ID", "KSK_U_ID");

        db.DB_Data_Get.DB_Tabellen.DB_set_Tabelle_Verknüpfung_Graph("LEFT JOIN", "cust_krankenschwester_stammdaten_anrede",
        ...
        db.DB_Data_Get.DB_Tabellen.DB_set_Tabelle_Verknüpfung("cust_protokoll_replagal_daten", "RIGHT JOIN", "view_balance_rx", "PRD_P_ID", "PB_ID_PATIENT and PB_ID_PRODUCT = 1");
        
        /* type */
        db.DB_Data_Get.DB_Tabellen.DB_set_Tabelle_Verknüpfung_Graph("/*t*/ LEFT JOIN", "/*a*/cust_protokoll_replagal_typ as ptype", "/*b*/cust_protokoll_replagal_daten", "ptype", "PRD_INFUSIONSTYP", "PRT_ID");
        ...
        db.DB_Data_Get.DB_Tabellen.DB_set_Tabelle_Verknüpfung("cust_protokoll_replagal_meta_static", "RIGHT JOIN", "cust_stammdaten_regionalleiter", "PREPMS_ID_REG_LEAD", "SRL_ID");
        ...
        if(patientId != null) {
            ...
            db.DB_Data_Get.DB_Filter.DB_WHERE_Allgemein("cust_protokoll_replagal_daten", "PRD_P_ID", "=", Integer.toString(patientId), glue);
        }
        ...
        if(pop_month.getValue() != null){
            ...
            java.sql.Timestamp sqlDateUntil = new java.sql.Timestamp(new LocalDateTime(pop_month.getValue()).plusMonths(1).minusMillis(1).toDate().getTime());
            
            filterList.remove(pop_month);
            glue = hasGlobalFilters(filterList) ? "AND" : "";
            
            db.DB_Data_Get.DB_Filter.DB_WHERE_BETWEEN("(cust_protokoll_replagal_daten", "PRD_DATE", "'" + sqlDateFrom.toString() + "'",  "'" + sqlDateUntil.toString() + "'", "OR");
            db.DB_Data_Get.DB_Filter.DB_WHERE_BETWEEN("(PRD_DATE IS NULL AND cust_protokoll_replagal_daten", "PRD_CREATED", "'" + sqlDateFrom.toString() + "'",  "'" + sqlDateUntil.toString() + "'))", glue);            
        ...
        if(cb_filterStatus.getValue() && ((Collection) tcol_filterStatus.getValue()).size() > 0){
            ...
            db.DB_Data_Get.DB_Filter.DB_WHERE_In("(cust_protokoll_replagal_daten", "PRD_STATUS", in, "OR");
            db.DB_Data_Get.DB_Filter.DB_WHERE_Allgemein("cust_protokoll_replagal_daten", "PRD_STATUS", "IS", "NULL)", glue);
        }
...
//        db.DB_Data_Get.DB_DEBUG_SQL_STRING();
        ...
        db.DB_Data_Get.DB_Ordnen.DB_Ordnen("PRD_ID", "ASC");

        /**************************************/

        // db.DB_Data_Get.Set_Type("Datum von", Date.class);
        // db.DB_Data_Get.Set_Type("Datum bis", Date.class);
        db.DB_Data_Get.Set_Type("regionalManagerOk", RegionalManager.class);
        db.DB_Data_Get.Set_Type("Land", Land.class);
        //TASK: ^ include in customQuery
...
//        db.debugNextQuery(true);
    ...
    private void dbDeleteData(Collection<Integer> ids){
        ...
        DBClass db = new DBClass();
        db.DB_Data_Delete.DB_Tabellen.DB_set_Tabelle_Einzeln("cust_protokoll_replagal_daten");
        db.DB_Data_Delete.DB_Filter.DB_WHERE_In("cust_protokoll_replagal_daten", "PRD_ID", Joiner.on(",").join(ids), "");
    ...
    private Integer dbCreate() {
        ...
        Integer vhId = MyUtils.getValueFromItem(item, "PRD_DELEGATION_ID", Integer.class);
        Integer nurseId = MyUtils.getValueFromItem(item, "PRD_K_ID", Integer.class);
        Integer patientId = MyUtils.getValueFromItem(item, "PRD_P_ID", Integer.class);
        Integer arztId = MyUtils.getValueFromItem(item, "PRD_ARZT_ID", Integer.class);

        
        CustomQuery q = new DBClass().CustomQuery;
        String sql = "INSERT INTO `cust_protokoll_replagal_daten` (PRD_DELEGATION_ID, PRD_K_ID, PRD_P_ID, PRD_ARZT_ID) VALUES"
             + "\n " + "("
