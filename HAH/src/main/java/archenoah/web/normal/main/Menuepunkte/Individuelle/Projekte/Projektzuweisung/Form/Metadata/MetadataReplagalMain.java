...
public class MetadataReplagalMain extends MetadataPanel {
//    public class MetadataReplagalMain extends CustomComponent {
    ...
    @AutoGenerated
        ...
        @AutoGenerated
        private Label lbl_volumeUnit;
        @AutoGenerated
        private IntStepper int_volume;
        @AutoGenerated
    ...
    final String table_static = "cust_protokoll_replagal_meta_static";
    final String table_dynamic = "cust_protokoll_replagal_meta_dynamic";
    
    /************ ----->Einstellungen<-- ********************/
    private final String LNG_FRM_ID = "2102";
...
//    /*************************************/
        ...
        btn_rrule.addClickListener(new ClickListener() {
            ...
            public void buttonClick(ClickEvent event) {
                ...
                if (rrule != null) {
                    ...
                    if(pop_dyn_dateActive.getValue() != null){
    ...
    private void editDynamicFields(Object itemId) {
        ...
        if (item != null) {
            ...
            metaDynamicId = (Integer) item.getItemProperty("PREPMD_ID").getValue();
            
            pop_dyn_dateDelegation.setValue((Date) item.getItemProperty("PREPMD_DELEGATION").getValue());
            pop_dyn_dateActive.setValue((Date) item.getItemProperty("PREPMD_ACTIVE").getValue());
            int_volume.setValue((Integer) item.getItemProperty("PREPMD_VOLUME").getValue());
            cb_homecare.setValue((Boolean) item.getItemProperty("PREPMD_HOMECARE").getValue());
            metaDynamicHomecareValue = (Boolean) item.getItemProperty("PREPMD_HOMECARE").getValue();
            txt_rrule_id.setValue(Integer.toString((Integer) item.getItemProperty("PREPMD_RRULE_ID").getValue()));
        } else {
    ...
    private void setDBMaps() {
        ...
        DBMapDynamic.put(pop_dyn_dateDelegation, "cust_protokoll_replagal_meta_dynamic:PREPMD_DELEGATION");
        DBMapDynamic.put(pop_dyn_dateActive, "cust_protokoll_replagal_meta_dynamic:PREPMD_ACTIVE");
        DBMapDynamic.put(int_volume, "cust_protokoll_replagal_meta_dynamic:PREPMD_VOLUME");
        DBMapDynamic.put(cb_homecare, "cust_protokoll_replagal_meta_dynamic:PREPMD_HOMECARE");
        DBMapDynamic.put(txt_rrule_id, "cust_protokoll_replagal_meta_dynamic:PREPMD_RRULE_ID");

        DBMapStatic = new HashMap<Object, String>();
        DBMapStatic.put(txt_patCode, "cust_protokoll_replagal_meta_static:PREPMS_PAT_CODE");
        DBMapStatic.put(txt_patInitials, "cust_protokoll_replagal_meta_static:PREPMS_PAT_INITIALS");
        DBMapStatic.put(cbx_regLead, "cust_protokoll_replagal_meta_static:PREPMS_ID_REG_LEAD");
        DBMapStatic.put(int_maxRep, "cust_protokoll_replagal_meta_static:PREPMS_MAX_REP");

        DBMapStatic.put(pdfType, "cust_protokoll_replagal_meta_static:PREPMS_PDF_TYPE");
        DBMapStatic.put(pdfFreq, "cust_protokoll_replagal_meta_static:PREPMS_PDF_FREQ");
    ...
    private void getStatic() {
        ...
        db.DB_Data_Get.DB_Tabellen.DB_set_Tabelle_Einzeln("cust_protokoll_replagal_meta_static");
        ...
        db.DB_Data_Get.DB_Filter.DB_WHERE_Allgemein("cust_protokoll_replagal_meta_static", "PREPMS_VH_ID", "=", wid, "");

        Container con = db.DB_Data_Get.DB_SEND_AND_GET_Container();
        Form_Bind fb = new Form_Bind();

        if (con.size() > 0) {
            staticId = Integer.toString((Integer) con.getItem(1).getItemProperty("PREPMS_ID").getValue());
    ...
    private void getRl(){
        ...
        db.DB_Data_Get.DB_Filter.DB_WHERE_Allgemein("cust_stammdaten_regionalleiter", "SRL_ID_PROJEKT", "=", projectId, "");
...
//        db.DB_Data_Get.DB_DEBUG_SQL_STRING();
    ...
    private void getNurses() {
        ...
        db.DB_Data_Get.DB_Filter.DB_WHERE_Allgemein("cust_projekte_stammdaten_liste", "PSLV_ID", "=", projectId, "");
    ...
    private void fillDynamicList() {
        ...
        DBClass db = new DBClass();
        db.DB_Data_Get.DB_Spalten.Standard.DB_set_Spalten_All();
        db.DB_Data_Get.DB_Tabellen.DB_set_Tabelle_Einzeln("cust_protokoll_replagal_meta_dynamic");
        ...
        db.DB_Data_Get.DB_Filter.DB_WHERE_Allgemein("cust_protokoll_replagal_meta_dynamic", "PREPMD_VH_ID", "=", wid, "");
        ...
        for (Object id : scon.getItemIds()) {
            scon.getItem(id)
                    ...
                    .setValue(
                            converter.convertToPresentation(scon.getItem(id).getItemProperty("PREPMD_DELEGATION").getValue(), String.class,
    ...
    private void fillNurseSubs() {
        ...
        db.DB_Data_Get.DB_Filter.DB_WHERE_Allgemein("cust_verk_subs", "CVS_PROJECT_ID", "=", projectId, "AND");
    ...
    private RruleItem dbGetRecurrenceRule(Integer delegationId) {
        ...
        String sql = "select * from cust_protokoll_rrules"
            + "\n " + "where RRL_ID = (select PREPMD_RRULE_ID from cust_protokoll_replagal_meta_dynamic where PREPMD_ID = " + delegationId + ")";
        q.setSqlString(sql);
    ...
    private Integer saveDynamic() {
        CMS_Config_Std std = CMS_Config_Std.getInstance();
        DBClass db = new DBClass();
        db.DB_Data_Insert.DB_Tabellen.DB_set_Tabelle_Einzeln("cust_protokoll_replagal_meta_dynamic");
        Form_Bind fb = new Form_Bind();
        fb.Insert(db, DBMapDynamic);

        db.DB_Data_Insert.DB_Daten.DB_Data("cust_protokoll_replagal_meta_dynamic", "PREPMD_VH_ID", getMainId());
...
//        db.DB_Data_Insert.DB_DEBUG_SQL_STRING();
    ...
    private void updateDynamic(){
        ...
        DBClass db = new DBClass();
        db.DB_Data_Update.DB_Tabellen.DB_set_Tabelle_Einzeln("cust_protokoll_replagal_meta_dynamic");
        db.DB_Data_Update.DB_Daten.DB_Data("cust_protokoll_replagal_meta_dynamic", "PREPMD_HOMECARE", cb_homecare.getValue() ? "1" : "0");

        db.DB_Data_Update.DB_Filter.DB_WHERE_Allgemein("cust_protokoll_replagal_meta_dynamic", "PREPMD_ID", "=", metaDynamicId.toString(), "");
...
//            dbc.DB_Data_Insert.DB_Daten.DB_Data("cust_protokoll_replagal_meta_dynamic", "PREPMD_VH_ID", getMainId());
...
//    }
    ...
    private Integer saveStatic() {
        CMS_Config_Std std = CMS_Config_Std.getInstance();
        DBClass db = new DBClass();
        db.DB_Data_Insert.DB_Tabellen.DB_set_Tabelle_Einzeln("cust_protokoll_replagal_meta_static");

        Form_Bind fb = new Form_Bind();
        fb.Insert(db, DBMapStatic);

        db.DB_Data_Insert.DB_Daten.DB_Data("cust_protokoll_replagal_meta_static", "PREPMS_VH_ID", getMainId());
    ...
    private void updateStatic() {
        CMS_Config_Std std = CMS_Config_Std.getInstance();
        DBClass db = new DBClass();
        db.DB_Data_Update.DB_Tabellen.DB_set_Tabelle_Einzeln("cust_protokoll_replagal_meta_static");

        Form_Bind fb = new Form_Bind();
        fb.Update(db, DBMapStatic);
        
        db.DB_Data_Update.DB_Filter.DB_WHERE_Allgemein("cust_protokoll_replagal_meta_static", "PREPMS_ID", "=", staticId, "");
    ...
    private void saveNurseSubs() {
        ...
        for (String id : toInsert) {
            ...
            db.DB_Data_Insert.DB_Daten.DB_Data("cust_verk_subs", "CVS_PROJECT_ID", projectId);
        ...
        for (String id : toDelete) {
            ...
            db.DB_Data_Delete.DB_Filter.DB_WHERE_Allgemein("cust_verk_subs", "CVS_PROJECT_ID", "=", projectId, "AND");
    ...
    public void setRecurrenceSettings(String Form_ID){
        ...
        db.DB_Data_Get.DB_Tabellen.DB_set_Tabelle_Verknüpfung("cust_verk_haupt", "INNER JOIN", table_static, "VH_ID", "PREPMS_VH_ID");
        db.DB_Data_Get.DB_Tabellen.DB_set_Tabelle_Verknüpfung("cust_verk_haupt", "INNER JOIN", table_dynamic, "VH_ID", "PREPMD_VH_ID");
        db.DB_Data_Get.DB_Tabellen.DB_set_Tabelle_Verknüpfung(table_dynamic, "INNER JOIN", "cust_protokoll_rrules", "PREPMD_RRULE_ID", "RRL_ID");
        
        db.DB_Data_Get.DB_Ordnen.DB_Ordnen("PREPMD_ACTIVE", "DESC");
        db.DB_Data_Get.DB_Ordnen.DB_Ordnen("PREPMD_CREATED", "DESC");
        ...
        if(settings != null){
            ...
            RecurrenceRepetitions = (Integer) settings.getItemProperty("PREPMS_MAX_REP").getValue();
            RecurrenceMetaId = (Integer) settings.getItemProperty("PREPMD_ID").getValue();
        }
        ...
        dbb.DB_Data_Get.DB_Tabellen.DB_set_Tabelle_Verknüpfung("cust_protokoll_replagal_daten", "INNER JOIN", table_dynamic, "PRD_DELEGATION_ID", "PREPMD_ID");
        
        dbb.DB_Data_Get.DB_Ordnen.DB_Ordnen("PRD_ORIGINAL_DATE", "DESC");
        dbb.DB_Data_Get.DB_Limit.DB_LIMIT("1");
        
        dbb.DB_Data_Get.DB_Filter.DB_WHERE_Allgemein(table_dynamic, "PREPMD_VH_ID", "=", Form_ID, "");
        
        //dbb.debugNextQuery(true);
        
        Item item = dbb.DB_Data_Get.DB_SEND_AND_GET_FIRST_ITEM();
        
        RecurrenceLatestDate = (item == null) ? null : (Date) item.getItemProperty("PRD_ORIGINAL_DATE").getValue();
    ...
    private VerticalLayout buildVerticalLayout_6() {
        ...
        verticalLayout_6.setComponentAlignment(horizontalLayout_2, new Alignment(48));
    ...
    private HorizontalLayout buildHorizontalLayout_2() {
        ...
        // int_volume
        int_volume = new IntStepper();
        int_volume.setCaption("Volumen");
        int_volume.setImmediate(false);
        int_volume.setWidth("60px");
        int_volume.setHeight("-1px");
        horizontalLayout_2.addComponent(int_volume);
        
        // lbl_volumeUnit
        lbl_volumeUnit = new Label();
        lbl_volumeUnit.setImmediate(false);
        lbl_volumeUnit.setWidth("-1px");
        lbl_volumeUnit.setHeight("-1px");
        lbl_volumeUnit.setValue("Ampullen");
        horizontalLayout_2.addComponent(lbl_volumeUnit);
        horizontalLayout_2.setComponentAlignment(lbl_volumeUnit, new Alignment(24));
    ...
    private Panel buildPan_verwaltung() {
        ...
        pan_verwaltung.setHeight("280px");
