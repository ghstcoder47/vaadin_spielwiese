...
public class Init_Menüpunkt_Entwicklung {
	...
	private static class msg extends I18nMB{
	    ...
	    static final I18nMB timebutler_error = set(Icon.ERROR, ButtonId.CLOSE);
	}
	...
	private final static class caption extends I18nCB {
        ...
        static final I18nCB timebutlerSync = set();
    }
	...
	private void Gen_men()
	{
        ...
        Entwicklerbereich.addItem(i18n.get(caption.timebutlerSync), Icons.Black.refresh_16, new Command() {

            @Override
            public void menuSelected(MenuItem selectedItem) {
                try {
                    new TimebutlerSyncJob().execute(null);
                } catch (JobExecutionException e) {
                    i18n.messageBox(msg.timebutler_error, null, new Label(e.getMessage()));
                }
            }
        });
