package archenoah.web.normal.main.Menuepunkte.Individuelle.Stammdaten.RegionalLeadsManager.form;
...
import archenoah.web.normal.main.Menuepunkte.Individuelle.Stammdaten.RegionalLeadsManager.form.RegionalLeadsDataView.ProjectConverter;
import archenoah.web.normal.main.Menuepunkte.Individuelle.Stammdaten.RegionalLeadsManager.form.RegionalLeadsDataView.UserConverter;
...
public class RegionalLeadsInsertEdit extends CustomComponent {
    ...
    private final String dataTableName = "cust_stammdaten_regionalleiter";
    ...
    public RegionalLeadsInsertEdit(MenuItem Arg_Menü, Integer dataSetId) {
        tmpMenu = Arg_Menü;
        this.dataSetId = dataSetId;
    }

    public RegionalLeadsInsertEdit(Button Arg_btn, Integer dataSetId) {
        tmpButton = Arg_btn;
        this.dataSetId = dataSetId;
    }
    ...
    private void fillDbMap() {
        ...
        dbMap = new HashMap<>();
        dbMap.put(user, table + "SRL_ID_USER");
        dbMap.put(project, table + "SRL_ID_PROJEKT");
        dbMap.put(region, table + "SRL_REGION");
...
//        q.db.debugNextQuery(true);
    ...
    private VerticalLayout buildVerticalLayout_4() {
        ...
        verticalLayout_4.addComponent(region);
        verticalLayout_4.setComponentAlignment(region, new Alignment(48));
