...
public class RegionalLeadsDataView extends CustomComponent {
    ...
    private final String tableIdCol = "SRL_ID";
    
    //TASK cols
    private final Object[] tableColsAll = new Object[] {"SRL_ID", "SRL_ID_USER", "SRL_ID_PROJEKT", "SRL_REGION"};
    ...
    public RegionalLeadsDataView(MenuItem Arg_Menü) {
        tmpMenu = Arg_Menü;
    }

    public RegionalLeadsDataView(Button Arg_btn) {
        tmpButton = Arg_btn;
    }
    ...
    public Command cmd_btn_add = new ClickCommand() {
        ...
        public void menuClicked(MenuItem selectedItem) {
            ...
            RegionalLeadsInsertEdit pie = new RegionalLeadsInsertEdit(btn_create, null);
    ...
    public Command cmd_btn_read = new ClickCommand() {
        ...
        public void menuClicked(MenuItem selectedItem) {
            ...
            RegionalLeadsInsertEdit pie = new RegionalLeadsInsertEdit(selectedItem, getSelectedId());
...
//            tbl_data.addGeneratedColumn("rx", new HtmlLabelColumnGenerator("rx", "rx_raw"));
        ...
        gen.addConverter("SRL_ID_PROJEKT", projectConverter);
        gen.addConverter("SRL_ID_USER", userConverter);
        gen.attach(tbl_data);
        
        tbl_data.setFilterGenerator(new TableFilterGenerator(tbl_data));
        
        tableUpdater = new FilteringTableUpdater(tbl_data);
        tableUpdater.showSum("SRL_REGION"); 
...
//        btn_create.setEnabled(crud);
	...
	private void dbGetContainer() {
        ...
        String sql = "select * from cust_stammdaten_regionalleiter";
        q.setSqlString(sql);
    ...
    private void dbDeleteData(Collection<Integer> ids){
        ...
        db.DB_Data_Delete.DB_Tabellen.DB_set_Tabelle_Einzeln("cust_stammdaten_regionalleiter");
        db.DB_Data_Delete.DB_Filter.DB_WHERE_In("cust_stammdaten_regionalleiter", tableIdCol, Joiner.on(",").join(ids), "");
