...
import archenoah.web.normal.main.Menuepunkte.Individuelle.TaskSystem.MeetingLogging.classes.MeetingPdfPrint;
...
public class MeetingLoggingDataView extends CustomComponent {
    ...
    /************ ----->Einstellungen<-- ********************/
//    private final String formIdLng = "303";
    private final String formIdPerm = "303";
    ...
    //TASK cols
    private final Object[] tableColsAll = new Object[] { "TMEL_ID", "TMEL_CREATED", "TMEG_NAME", "editor", "TMEL_DATE", "TMEL_TIME_START", "TMEL_TIME_END", "TMEL_NEXT_EVENT" };
    ...
    public MeetingLoggingDataView(MenuItem Arg_Menü) {
        tmpMenu = Arg_Menü;
    }

    public MeetingLoggingDataView(Button Arg_btn) {
        tmpButton = Arg_btn;
    }
    ...
    public ClickCommand cmd_btn_add = new ClickCommand() {
        ...
        public void menuClicked(MenuItem selectedItem) {
        	...
        	MeetingLoggingInsertEdit pie = new MeetingLoggingInsertEdit(selectedItem, "");
    ...
    public ClickCommand cmd_btn_read = new ClickCommand() {
        ...
        public void menuClicked(MenuItem selectedItem) {
            ...
            MeetingLoggingInsertEdit pie = new MeetingLoggingInsertEdit(selectedItem, getSelectedValue());
    ...
    private void generateMenu() {
        ...
        btn_export = men_frm.addItem("FRM_EXPORT", Icons.White.log_16, null);
    ...
    private void configureComponents(){
        ...
        MeetingPdfPrint print = new MeetingPdfPrint(tbl_data);
        print.attach(mainLayout, btn_export);
    }
...
//        btn_delete.setEnabled(crud || multi);
        btn_delete.setEnabled(crud); // single select for now
        
        btn_export.setEnabled(multi);
    }
...
//        }
    ...
    private void configureTable() {
        ...
        if(tbl_data.size() > 0){
            ...
            StringSqlTimestampConverter datetime = new StringSqlTimestampConverter();
            datetime.setDateFormat(DateFormat.SHORT);
            datetime.setTimeFormat(DateFormat.SHORT);
            
            StringSqlTimestampConverter time = new StringSqlTimestampConverter();
            time.setDateFormat(0);
            time.setTimeFormat(DateFormat.SHORT);
            
            tbl_data.setConverter("TMEL_DATE", date);
            tbl_data.setConverter("TMEL_NEXT_EVENT", date);
            tbl_data.setConverter("TMEL_CREATED", datetime);
            
            tbl_data.setConverter("TMEL_TIME_START", time);
            tbl_data.setConverter("TMEL_TIME_END", time);
            
        
        }
        
        tableUpdater = new FilteringTableUpdater(tbl_data);
        tableUpdater.showSum("TMEL_NEXT_EVENT");

        for (Object col : tableColsAll) {
        	
        	try {
        		tbl_data.setColumnExpandRatio(col, 2);
			} catch (Exception e) {
        ...
        tbl_data.setColumnExpandRatio("TMEL_ID", 0);
        tbl_data.setColumnExpandRatio("TMEG_NAME", 3);
        tbl_data.setColumnExpandRatio("TMEL_DATE", 1);

        tbl_data.setColumnExpandRatio("TMEL_TIME_START", 0);
        tbl_data.setColumnExpandRatio("TMEL_TIME_END", 0);
	...
	private void dbGetContainer() {
        ...
        db.DB_Data_Get.DB_Spalten.Standard.DB_set_Spalten_Einzeln("CONCAT(cms_auth_stammdaten_user.AUL_VORNAME, ' ', cms_auth_stammdaten_user.AUL_NAME)", "editor");
        /**************************************/
        /************ Set Tabelle *************/
//        db.DB_Data_Get.DB_Tabellen.DB_set_Tabelle_Einzeln("cust_taskmanager_meeting_logs");
        
        db.DB_Data_Get.DB_Tabellen.DB_set_Tabelle_Verknüpfung("cust_taskmanager_meeting_logs", "LEFT JOIN", "cms_auth_stammdaten_user", "TMEL_ID_EDITOR", "AUL_ID");
        db.DB_Data_Get.DB_Tabellen.DB_set_Tabelle_Verknüpfung("cust_taskmanager_meeting_groups", "RIGHT JOIN", "cust_taskmanager_meeting_logs", "TMEG_ID", "TMEL_ID_TEAM");
        ...
        if(uid == null) {
            db.DB_Data_Get.DB_Filter.DB_WHERE_In("cust_taskmanager_meeting_logs", "TMEL_ID", "0", glue);
        }else if(uid != 1) {
            db.DB_Data_Get.DB_Filter.DB_WHERE_In("cust_taskmanager_meeting_logs", "TMEL_ID_EDITOR", uid.toString(), glue);
        }
...
//        }
        ...
        db.DB_Data_Get.Set_Type("TMEL_TIME_START", Time.class);
        db.DB_Data_Get.Set_Type("TMEL_TIME_END", Time.class);
    ...
    private void dbDeleteData(String id){
        ...
        DBClass db = new DBClass();
        db.DB_Data_Delete.DB_Tabellen.DB_set_Tabelle_Einzeln("cust_taskmanager_meeting_logs");
        db.DB_Data_Delete.DB_Filter.DB_WHERE_Allgemein("cust_taskmanager_meeting_logs", tableIdCol, "=", id, "");
