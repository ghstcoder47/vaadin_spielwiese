...
public class data_view_aerzteverwaltung extends CustomComponent {
...
//    private String LNG_FRM_ID = "12";
    ...
    private String TBL_ID = "ASA_ID";

    private String NOT_Del = "21";

    private String Exporttitel = "Arzt Uebersicht";
    private String Export_Filename = "Arzt_Uebersicht.xls";

    private I18nManager i18n;

    /******************************************************/

    public data_view_aerzteverwaltung(MenuItem Arg_Menü) {
        Temp_Menü = Arg_Menü;

        // TODO add user code here
    }

    public data_view_aerzteverwaltung(Button Arg_btn) {
    ...
    private void configureComponents() {
        ...
        Btn_Add.setIcon(Icons.White.add_16);
    ...
    public ClickCommand cmd_btn_add = new ClickCommand() {
        ...
        public void menuClicked(MenuItem selectedItem) {
            ...
            form_arzt_insert_edit pie = new form_arzt_insert_edit(selectedItem, "");
    ...
    private Container Get_Data_Container() {
        try {
            ...
            db.DB_Data_Get.DB_Spalten.Standard.DB_set_Spalten_Einzeln("CONCAT(AUL_NAME,', ',AUL_VORNAME,', ', ASAN_NAME,' ',ASA_TITEL)", "Arzt");
            db.DB_Data_Get.DB_Spalten.Standard.DB_set_Spalten_Einzeln("ASA_STRASSE", "'Strasse'");
            db.DB_Data_Get.DB_Spalten.Standard.DB_set_Spalten_Einzeln("ASA_ORT", "'Ort'");
            db.DB_Data_Get.DB_Spalten.Standard.DB_set_Spalten_Einzeln("ASA_PLZ", "'PLZ'");
            db.DB_Data_Get.DB_Spalten.Standard.DB_set_Spalten_Einzeln("AUL_TEL", "'Telefon'");
            db.DB_Data_Get.DB_Spalten.Standard.DB_set_Spalten_Einzeln("ASA_HANDY", "'Handy'");
            db.DB_Data_Get.DB_Spalten.Standard.DB_set_Spalten_Einzeln("ASA_INSTITUT", "'Institut'");
    ...
    private void Filter_Krankenschwester(DBClass db) {
        ...
        dba.DB_Data_Get.DB_Spalten.Standard.DB_set_Spalten_Einzeln("VH_ARZT_ID");
        dba.DB_Data_Get.DB_Tabellen.DB_set_Tabelle_Verknüpfung("cust_krankenschwester_stammdaten_ks", "INNER JOIN", "cms_auth_stammdaten_user", "KSK_U_ID", "AUL_ID");
        dba.DB_Data_Get.DB_Tabellen.DB_set_Tabelle_Verknüpfung("cust_krankenschwester_stammdaten_ks", "INNER JOIN", "cust_verk_haupt", "KSK_ID", "VH_NURSE_ID");
        ...
        if (con.size() > 0) {
            ...
            for (Object ItemIda : con.getItemIds()) {
                ...
                if (anz == menge) {
                    db.DB_Data_Get.DB_Filter.DB_WHERE_Allgemein("cust_arzt_stammdaten_arzt", "ASA_ID", "=", "'" + con.getItem(ItemIda).getItemProperty("VH_ARZT_ID").getValue().toString() + "'", "");
                } else {
                    db.DB_Data_Get.DB_Filter.DB_WHERE_Allgemein("cust_arzt_stammdaten_arzt", "ASA_ID", "=", "'" + con.getItem(ItemIda).getItemProperty("VH_ARZT_ID").getValue().toString() + "'", "OR");
                }
            }

        } else {
            db.DB_Data_Get.DB_Filter.DB_WHERE_Allgemein("cust_arzt_stammdaten_arzt", "ASA_ID", "=", "'" + "" + "'", "");
        }
    ...
    private void Datenholen_force() {
        ...
        if (con.size() > 0) {
            ...
            tbl_frm.setVisibleColumns(new Object[] { "Arzt", "Strasse", "Ort", "PLZ", "Institut", "Telefon", "Handy", "Email" });
        } else {
    ...
    private void Datenholen() {
        ...
        if (con != null && con.size() > 0) {
            ...
            tbl_frm.setColumnFooter("Telefon", "Insgesamt: " + tbl_frm.size() + " Ärzte");
    ...
    private void Del(int ID) {
        ...
        DBClass db = new DBClass();
        db.DB_Data_Delete.DB_Tabellen.DB_set_Tabelle_Verknüpfung("cms_auth_stammdaten_user", "INNER JOIN", "cust_arzt_stammdaten_arzt", "AUL_ID", "ASA_U_ID");
        db.DB_Data_Delete.DB_Filter.DB_WHERE_Allgemein("cust_arzt_stammdaten_arzt", "ASA_ID", "=", ID + "", "");
