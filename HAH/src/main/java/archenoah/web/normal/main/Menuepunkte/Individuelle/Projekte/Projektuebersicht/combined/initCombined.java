package archenoah.web.normal.main.Menuepunkte.Individuelle.Projekte.Projektuebersicht.combined;


//import archenoah.lib.vaadin.Components.Window_Tab_Generierer.Build_Tab_Menue_Item;
import archenoah.web.normal.main.Menuepunkte.Individuelle.Projekte.Projektuebersicht.combined.form.CombinedDataView;
...
public class initCombined {


	private TabSheet tab;
	private CombinedDataView dataview;
	
	public initCombined(MenuItem menü)
	{
		...
		dataview = new CombinedDataView(menü);
    ...
    public CombinedDataView getDataView(){
        return dataview;
    }
