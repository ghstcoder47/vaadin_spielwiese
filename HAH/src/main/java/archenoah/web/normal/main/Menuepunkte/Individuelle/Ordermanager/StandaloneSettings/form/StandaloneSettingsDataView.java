...
public class StandaloneSettingsDataView extends CustomComponent {
    ...
    /************ ----->Einstellungen<-- ********************/
//    private final String formIdLng = "108";
    ...
    private final String tableIdCol = "OMS_ID";
    
    //TASK cols
    private final Object[] tableColsAll = new Object[] {"OMS_ID", "OMS_CREATED", "OMS_UPDATED", "PP_PRODUCT", "patient", "OMS_RRULE_START", "OMS_RRULE"};
    ...
    public StandaloneSettingsDataView(MenuItem Arg_Menü) {
        tmpMenu = Arg_Menü;
    }

    public StandaloneSettingsDataView(Button Arg_btn) {
        tmpButton = Arg_btn;
    }
    ...
    public Command cmd_btn_add = new Command() {
        ...
        public void menuSelected(MenuItem selectedItem) {
        	...
        	StandaloneSettingsInsertEdit pie = new StandaloneSettingsInsertEdit(selectedItem, "");
    ...
    public Command cmd_btn_read = new Command() {
        ...
        public void menuSelected(MenuItem selectedItem) {
            ...
            StandaloneSettingsInsertEdit pie = new StandaloneSettingsInsertEdit(selectedItem, getSelectedValue());
...
//        }
    ...
    private void configureTable() {
        ...
        if(tbl_data.size() > 0){
            ...
            tbl_data.setConverter("OMS_CREATED", time);
            tbl_data.setConverter("OMS_UPDATED", time);
            tbl_data.setConverter("OMS_RRULE_START", date);
        ...
        tbl_data.setColumnExpandRatio("OMS_ID", 0);
    }
...
//        ArrayList<AbstractField> filterList = getActiveGlobalFilters(); 
    ...
    private void dbDeleteData(String id){
        ...
        db.DB_Data_Delete.DB_Tabellen.DB_set_Tabelle_Einzeln("cust_ordermanager_standalone");
        db.DB_Data_Delete.DB_Filter.DB_WHERE_Allgemein("cust_ordermanager_standalone", tableIdCol, "=", id, "");
