...
public class CommentWrapper extends CustomComponent {
    ...
    private Converter<String, Object> originConverter;
    // {end fields}
    ...
    public void setValue(Item item) {
        ...
        Timestamp cr = MyUtils.getValueFromItem(item, "C_CREATED", java.sql.Timestamp.class);
        Timestamp up = MyUtils.getValueFromItem(item, "C_UPDATED", java.sql.Timestamp.class);
        ...
        author.setValue(authorConverter.convertToPresentation(MyUtils.getValueFromItem(item, "C_ID_AUTHOR", Integer.class), String.class, getLocale()));
        origin.setValue(originConverter.convertToPresentation(MyUtils.getValueFromItem(item, "C_ID_ORIGIN", Integer.class), String.class, getLocale()));
        data.setValue(MyUtils.getValueFromItem(item, "C_DATA", Integer.class));
    }
    ...
    public void setOriginConverter(Converter<String, Object> converter) {
        this.originConverter = converter;
    }
...
//        comment.setNullRepresentation("");
    ...
    private HorizontalLayout buildHorizontalLayout_1() {
        ...
        origin.setCaption("Typ");
        origin.setImmediate(false);
        origin.setWidth("-1px");
        origin.setHeight("-1px");
        horizontalLayout_1.addComponent(origin);
        horizontalLayout_1.setComponentAlignment(origin, new Alignment(33));
