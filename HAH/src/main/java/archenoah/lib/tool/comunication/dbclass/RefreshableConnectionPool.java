...
public class RefreshableConnectionPool implements JDBCConnectionPool {

    private static org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(RefreshableConnectionPool.class);
    ...
    private transient LinkedHashSet<Connection> availableConnections;
    private transient LinkedHashSet<Connection> reservedConnections;

    private boolean initialized;

    public RefreshableConnectionPool(String driverName, String connectionUri,
    ...
    private void initializeConnections() throws SQLException {
        availableConnections = new LinkedHashSet<Connection>(initialConnections);
        reservedConnections = new LinkedHashSet<Connection>(initialConnections);
    ...
    public LinkedHashSet<Connection> getAvailableConnections() {
        return availableConnections;
    }

    public LinkedHashSet<Connection> getReservedConnections() {
